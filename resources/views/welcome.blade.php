...
@section('content')
                    <div class="px-5 mx-auto mt-6 screen">
                        <div class="logo-absolute">
                            <img src="{{Vite::asset('./resources/img/logo-jdw-trans-black.png')}}" alt="logojdw">
                        </div>
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                         ...
                         <i class="text-2xl fa-solid fa-microchip"></i>
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <img src="{{Vite::asset('./resources/img/laravel-logo.svg')}}" alt="">
                                    <img src="{{Vite::asset('./resources/img/PHP-logo.svg')}}" alt="">
                                </div>
