<footer class="bg-blue-800 text-white text-center py-4" style="background-image: url({{ Vite::asset('./resources/img/logo-jdw-trans-black.png') }}); background-repeat: no-repeat; background-position: center; background-size: 15%; opacity: 0.9; ">
    <div class="container flex justify-between items-center mx-auto gap-6 md:flex-row flex-col">
        <div >
        ...
        <div class="text-right">
            ...
            <div class="flex-cols">
                <span>hosted by:</span>
                <svg aria-label="Aruba.it" class="navbar-brand-svg h-9" id="logo-aruba" version="1.1" viewBox="0 0 445.3 125.4" x="0px"
